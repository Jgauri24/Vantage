...
const TransactionHistory = ({ limit = 10 }) => {
    ...
    const getTransactionIcon = (type) => {
        switch (type) {
            ...
            case 'job_earning':
                return (
                    <div className="w-10 h-10 rounded-full bg-accent-gold/20 flex items-center justify-center">
                        <svg className="w-5 h-5 text-[var(--color-accent-gold-hover)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            default:
                return (
                    <div className="w-10 h-10 rounded-full bg-secondary-bg/20 flex items-center justify-center">
                                    ...
                                    <div className="flex items-start justify-between gap-4">
                                        <div className="flex-1">
                                            ...
                                            {transaction.relatedJob && (
                                                <p className="text-xs text-[var(--color-accent-gold-hover)] mt-1">
